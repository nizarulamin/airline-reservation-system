...
<body>
  ...
  <div class="container">
    ...
    <form action="flight-selection.jsp" method="get">
      ...
      <select type="text" id="origin" name="origin" placeholder="Departure city" required>
      ...
      <select type="text" id="to" name="destination" placeholder="Destination city" required>
     ...
     <!-- <label for="cabin-class">Cabin Class:</label>
      ...
      <input type="submit" onclick="myFunction" value="Search Flights">
    </form>
  </div>
