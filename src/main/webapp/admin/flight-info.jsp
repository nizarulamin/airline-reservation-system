                              ...
                              <table class="table table-bordered">
                                <tbody>
                                  ...
                                  <% try { //Retrieve data from database Class.forName("com.mysql.jdbc.Driver");
                                    ...
                                    st=con.createStatement(); //display all String str="select * from flight" ;
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <%=rs.getString("flight_destination") %>
                                      </td>
                                      <td>
                                        <%=rs.getString("flight_departure") %>
                                      </td>
                                      <td>
                                        <%=rs.getString("flight_return") %>
                                      </td>
                                      <td>
                                      ...
                                      <td><a href="admin-edit-flight.jsp?id=<%=rs.getInt(" idflight") %>"><button
                                            class="badge bg-red">EDIT</button></a></td>
                                    </tr>
